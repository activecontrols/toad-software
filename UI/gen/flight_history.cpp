...
void commit_packet(gnc_telemetry_t packet) {
  FlightHistory.gnc.accel.x[write_pos] = packet.accel.x;
  FlightHistory.gnc.accel.x[write_pos + FLIGHT_HISTORY_LENGTH] = packet.accel.x;
  FlightHistory.gnc.accel.y[write_pos] = packet.accel.y;
  FlightHistory.gnc.accel.y[write_pos + FLIGHT_HISTORY_LENGTH] = packet.accel.y;
  FlightHistory.gnc.accel.z[write_pos] = packet.accel.z;
  FlightHistory.gnc.accel.z[write_pos + FLIGHT_HISTORY_LENGTH] = packet.accel.z;
  ...
  FlightHistory.gnc.mag.x[write_pos] = packet.mag.x;
  FlightHistory.gnc.mag.x[write_pos + FLIGHT_HISTORY_LENGTH] = packet.mag.x;
  FlightHistory.gnc.mag.y[write_pos] = packet.mag.y;
  FlightHistory.gnc.mag.y[write_pos + FLIGHT_HISTORY_LENGTH] = packet.mag.y;
  FlightHistory.gnc.mag.z[write_pos] = packet.mag.z;
  FlightHistory.gnc.mag.z[write_pos + FLIGHT_HISTORY_LENGTH] = packet.mag.z;
  FlightHistory.gnc.gps_pos.north[write_pos] = packet.gps_pos.north;
  FlightHistory.gnc.gps_pos.north[write_pos + FLIGHT_HISTORY_LENGTH] = packet.gps_pos.north;
  FlightHistory.gnc.gps_pos.west[write_pos] = packet.gps_pos.west;
  FlightHistory.gnc.gps_pos.west[write_pos + FLIGHT_HISTORY_LENGTH] = packet.gps_pos.west;
  FlightHistory.gnc.gps_pos.up[write_pos] = packet.gps_pos.up;
  FlightHistory.gnc.gps_pos.up[write_pos + FLIGHT_HISTORY_LENGTH] = packet.gps_pos.up;
  FlightHistory.gnc.gps_vel.north[write_pos] = packet.gps_vel.north;
  FlightHistory.gnc.gps_vel.north[write_pos + FLIGHT_HISTORY_LENGTH] = packet.gps_vel.north;
  FlightHistory.gnc.gps_vel.west[write_pos] = packet.gps_vel.west;
  FlightHistory.gnc.gps_vel.west[write_pos + FLIGHT_HISTORY_LENGTH] = packet.gps_vel.west;
  FlightHistory.gnc.gps_vel.up[write_pos] = packet.gps_vel.up;
  FlightHistory.gnc.gps_vel.up[write_pos + FLIGHT_HISTORY_LENGTH] = packet.gps_vel.up;
  ...
  FlightHistory.gnc.target_pos.north[write_pos] = packet.target_pos.north;
  FlightHistory.gnc.target_pos.north[write_pos + FLIGHT_HISTORY_LENGTH] = packet.target_pos.north;
  FlightHistory.gnc.target_pos.west[write_pos] = packet.target_pos.west;
  FlightHistory.gnc.target_pos.west[write_pos + FLIGHT_HISTORY_LENGTH] = packet.target_pos.west;
  FlightHistory.gnc.target_pos.up[write_pos] = packet.target_pos.up;
  FlightHistory.gnc.target_pos.up[write_pos + FLIGHT_HISTORY_LENGTH] = packet.target_pos.up;
